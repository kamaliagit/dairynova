      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          for (var doc in docs) {
            ...
            double amount = (data['totalAmount'] ?? data['total'] ?? 0)
                .toDouble();
                  ...
                  : FutureBuilder<DocumentSnapshot>(
                      ...
                      builder: (context, farmSnap) {
                        ...
                        if (farmSnap.hasData && farmSnap.data!.exists) {
                          realName =
                              (farmSnap.data!.data()
                                  as Map<String, dynamic>)['farmName'] ??
                              "Unnamed Farm";
                        } else if (farmSnap.connectionState ==
                                ConnectionState.done &&
                            !farmSnap.data!.exists) {
        ...
        children: [
          ...
          Row(
            ...
            children: docs.take(6).map((doc) {
              final data = doc.data() as Map<String, dynamic>;
              double val = (data['totalAmount'] ?? data['total'] ?? 0)
                  .toDouble();
