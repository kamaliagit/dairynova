...
import '../screens/rider/rider_dashboard.dart'; // Ensure path is correct
          ...
          if (dbRole == 'Super Admin') {
            ...
            if (status == 'new') {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => const RegisterFarmScreen(),
                ),
              );
            ...
            setState(() => isLoading = false);
            // FIXED: Added riderId parameter and ensured class name matches
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => RiderDashboard(riderId: user.uid),
              ),
            );
          }
        }
