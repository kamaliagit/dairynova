...
class VerifiedFarmsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const Color kPrimaryColor = Color(
      0xFF2E7D32,
    ); // Sync with your Dashboard theme
                ...
                child: farmDocs.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final farmData =
                              farmDocs[index].data() as Map<String, dynamic>? ??
                              {};
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Text(
                                "Owner: ${farmData['ownerName'] ?? 'Unknown'}",
                              ),
                              trailing: const Icon(
                                Icons.verified,
                                color: Colors.blue,
          ...
          children: [
            ...
            if (farm['updatedAt'] != null)
              _detailRow(
                ...
                DateFormat(
                  'dd MMM yyyy',
                ).format((farm['updatedAt'] as Timestamp).toDate()),
              ),
